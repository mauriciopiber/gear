...
class AbstractFormTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $abstract = $this->getMockBuilder('TestUntil\Form\AbstractForm')
    ...
    public function testSetEntityManager()
    {
        ...
        $this->bootstrap
        ->getServiceManager()
        ->get('ServiceManager')->setService('doctrine.entitymanager.orm_default',  $this->bootstrap->getEntityManager());
