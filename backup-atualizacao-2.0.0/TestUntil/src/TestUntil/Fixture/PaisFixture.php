...
class PaisFixture extends AbstractFixture implements FixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $roleGuest->setCreatedBy($userGearCli);
        ...
        $roleAdmin->setCreatedBy($userGearCli);
        $manager->persist($roleAdmin);
        $manager->flush();

        $userGearCli->addIdRole($roleAdmin);
        ...
        $user = $manager->getRepository('TestUntil\Entity\User')->findOneBy(array('idUser' => $userGearCli->getIdUser()));
        ...
        foreach ($paises as $nome)
        {
            $pais = new \TestUntil\Entity\Pais();
            $pais->setNome($nome);
            $pais->setCreated(new \DateTime('now'));
            $pais->setCreatedBy($user);
