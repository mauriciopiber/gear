 ...
 * Weekday
 *
 * @ORM\Table(name="weekday", indexes={@ORM\Index(name="created_by", columns={"created_by"}), @ORM\Index(name="updated_by", columns={"updated_by"})})
 * @ORM\Entity
 */
class Weekday
{
     ...
     * @var integer
     *
     * @ORM\Column(name="id_weekday", type="integer", nullable=false)
     * @ORM\Id
