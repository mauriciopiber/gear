<?php
namespace TestUpload\TestUploadTest\RepositoryTest;

/**
 * @SuppressWarnings(PHPMD.TooManyMethods)
 * @group Service
 */
class AbstractServiceTest extends \TestUploadTest\AbstractTest
{
    protected $user;
    ...
    {
        $abstractService = $this->getMockBuilder('TestUpload\Service\AbstractService')
        ->disableOriginalConstructor()
        ->setMethods(array('getRouteMatch'))
        ->getMockForAbstractClass();

        $routeMatch = new \Zend\Mvc\Router\Http\RouteMatch(array(
            'controller' => 'TestUpload\Controller\User',
            'action'     => 'list',
            'page'       => 1,
            'orderBy'    => 'idUser',
            'order'      => 'asc'
