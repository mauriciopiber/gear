 ...
 * @group Repository
 */
class AbstractRepositoryTest extends \TestUploadTest\AbstractTest
{

    protected $pais;
    /**
     * @cover TestUpload\Repository\AbstractRepository::getHydratorObject
     */
    public function testGetSecurityHydrator()
    {
        $abstractRepository = $this->getMockAbstractClass('TestUpload\Repository\AbstractRepository');
    ...
    {
        $abstractRepository = $this->getMockAbstractClass('TestUpload\Repository\AbstractRepository', array(
            'getSelect',
            'getRepositoryName',
            'setUpJoin',
            'getAliase',
    ...
    public function testGetUser()
    {
        ...
        $mockUser = $this->getMockSingleClass('Security\Entity\User', array('getIdUser', 'getEmail'));
        ...
        $mockUser->expects($this->any())
        ->method('getEmail')
        ->willReturn('usuariogear1@gmail.com');

        $entityRepository = $this->getMockSingleClass('Doctrine\ORM\EntityRepository', array(
            'findOneBy'
        ));
        ...
        $emMock = $this->getMockSingleClass(
        ...
        $this->assertInstanceOf('Security\Entity\User', $user);
        $this->assertEquals('9999', $user->getIdUser());
        $this->assertEquals('usuariogear1@gmail.com', $user->getEmail());
    }

    public function testExtract()
    {
        $abstractRepository = $this->getMockAbstractClass('TestUpload\Repository\AbstractRepository', array('extract'));
        $abstractRepository->setEntityManager($this->bootstrap->getEntityManager());
        ...
        $abstractRepository->expects($this->any())
        ->method('extract')
        ->willReturn(array('idUser' => 9999, 'email' => 'usuariogear1@gmail.com'));


        $data = $abstractRepository->extract($mockUser);

        $this->assertEquals('9999', $data['idUser'***REMOVED***);
    ...
    {
        $abstractRepository = $this->mockAbstractRepository();
