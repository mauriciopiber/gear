...
module=ColumnsNotNullUnique
moduleUrl="columns-not-null-unique"
...
php $index gear module db create $module --table="ColumnsNotNullUnique" --columns="$columns" --user=strict
php $index gear module db create $module --table="ForeignKeysCopy" --user=strict
