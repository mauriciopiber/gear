...
php $index gear module db create Column --table="Columns" --columns="$columns" --user=low-strict
php $index gear module db create Column --table="ForeignKeys" --user=low-strict
