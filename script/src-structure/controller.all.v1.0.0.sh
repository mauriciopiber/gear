...
cd $gear && sudo php $index gear module controller create $module $basePath --name="Console001" --type="console"
cd $gear && sudo php $index gear module activity create $module $basePath Console001 --name="Action001"
cd $gear && sudo php $index gear module activity create $module $basePath Console001 --name="Action002"
cd $gear && sudo php $index gear module activity create $module $basePath Console001 --name="Action003"
cd $gear && sudo php $index gear module activity create $module $basePath Console001 --name="Action004"
cd $gear && sudo php $index gear module activity create $module $basePath Console001 --name="Action005"
cd $gear && sudo php $index gear module activity create $module $basePath Console001 --name="Action006"

cd $gear && sudo php $index gear module controller create $module $basePath --name="Console002" --service="factories"  --type="console"
cd $gear && sudo php $index gear module activity create $module $basePath Console002 --name="Action001"
cd $gear && sudo php $index gear module activity create $module $basePath Console002 --name="Action002"
cd $gear && sudo php $index gear module activity create $module $basePath Console002 --name="Action003"
cd $gear && sudo php $index gear module activity create $module $basePath Console002 --name="Action004"
cd $gear && sudo php $index gear module activity create $module $basePath Console002 --name="Action005"
cd $gear && sudo php $index gear module activity create $module $basePath Console002 --name="Action006"

cd $gear && sudo php $index gear module controller create $module $basePath --name="Console003" --service="factories" --namespace=Namespace1  --type="console"
cd $gear && sudo php $index gear module activity create $module $basePath Console003 --name="Action001"
cd $gear && sudo php $index gear module activity create $module $basePath Console003 --name="Action002"
cd $gear && sudo php $index gear module activity create $module $basePath Console003 --name="Action003"
cd $gear && sudo php $index gear module activity create $module $basePath Console003 --name="Action004"
cd $gear && sudo php $index gear module activity create $module $basePath Console003 --name="Action005"
cd $gear && sudo php $index gear module activity create $module $basePath Console003 --name="Action006"

cd $gear && sudo php $index gear module controller create $module $basePath --name="Console004" --service="factories" --namespace=Namespace1\\Namespace2  --type="console"
cd $gear && sudo php $index gear module activity create $module $basePath Console004 --name="Action001"
cd $gear && sudo php $index gear module activity create $module $basePath Console004 --name="Action002"
cd $gear && sudo php $index gear module activity create $module $basePath Console004 --name="Action003"
cd $gear && sudo php $index gear module activity create $module $basePath Console004 --name="Action004"
cd $gear && sudo php $index gear module activity create $module $basePath Console004 --name="Action005"
cd $gear && sudo php $index gear module activity create $module $basePath Console004 --name="Action006"


cd $gear && sudo php $index gear module controller create $module $basePath --name="Console005" --service="factories" --namespace=Namespace1 --extends=Controller\\Console001  --type="console"
cd $gear && sudo php $index gear module activity create $module $basePath Console005 --name="Action001"
cd $gear && sudo php $index gear module activity create $module $basePath Console005 --name="Action002"
cd $gear && sudo php $index gear module activity create $module $basePath Console005 --name="Action003"
cd $gear && sudo php $index gear module activity create $module $basePath Console005 --name="Action004"
cd $gear && sudo php $index gear module activity create $module $basePath Console005 --name="Action005"
cd $gear && sudo php $index gear module activity create $module $basePath Console005 --name="Action006"


cd $gear && sudo php public/index.php gear module src create $module $basePath --name="ServiceConsole001" --type="Service" --service="factories" --namespace="Namespace1"
cd $gear && sudo php public/index.php gear module src create $module $basePath --name="ServiceConsole002" --type="Service" --service="factories" --namespace="Namespace1\\Namespace2"
cd $gear && sudo php public/index.php gear module src create $module $basePath --name="ServiceConsole003" --type="Service" --service="factories" --namespace="Namespace1\\Namespace2\\Namespace3"

cd $gear && sudo php $index gear module controller create $module $basePath --name="Console006" --service="factories" --namespace=Namespace1 --extends=Controller\\Console001  --type="console"
cd $gear && sudo php $index gear module activity create $module $basePath Console006 --name="Action001" --dependency="Namespace1\\ServiceConsole001"
cd $gear && sudo php $index gear module activity create $module $basePath Console006 --name="Action002" --dependency="Namespace1\\Namespace2\\ServiceConsole002"
cd $gear && sudo php $index gear module activity create $module $basePath Console006 --name="Action003" --dependency="Namespace1\\Namespace2\\Namespace3\\ServiceConsole003"
cd $gear && sudo php $index gear module activity create $module $basePath Console006 --name="Action004" --dependency="Namespace1\\ServiceConsole001"
cd $gear && sudo php $index gear module activity create $module $basePath Console006 --name="Action005" --dependency="Namespace1\\Namespace2\\ServiceConsole002"
cd $gear && sudo php $index gear module activity create $module $basePath Console006 --name="Action006" --dependency="Namespace1\\Namespace2\\Namespace3\\ServiceConsole003"
