...
php public/index.php gear module src create Gear --name="AppControllerSpecService" --type="Service" --extends="Mvc\\AbstractMvcTest"   --namespace="Mvc\\View\\App"

php public/index.php gear module src create Gear --name="AppServiceService" --type="Service" --extends="Mvc\\AbstractMvc" --dependency="Mvc\\View\\App\\AppServiceSpecService"  --namespace="Mvc\\View\\App"
php public/index.php gear module src create Gear --name="AppControllerService" --type="Service"  --extends="Mvc\\AbstractMvc"  --dependency="Mvc\\View\\App\\AppControllerSpecService"  --namespace="Mvc\\View\\App"
