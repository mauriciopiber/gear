...
php ../../public/index.php gear src create Teste --type="Entity" --name="TestingSuite" --db="TestingSuite"
php ./../../public/index.php gear src create Teste --type="Fixture" --name="TestingSuite" --db="TestingSuite"
...
#
#php ./../../public/index.php gear src create Teste --type="Repository" --name="MyAbstractRepository" --abstract
php ./../../public/index.php gear src create Teste --type="Repository" --name="TestingSuiteRepository" --db="TestingSuite" --columns="{\"test_varchar_email\": \"email\",\"test_decimal_money_pt_br\": \"money-pt-br\",\"test_date_pt_br\": \"date-pt-br\",\"test_datetime_pt_br\": \"datetime-pt-br\",\"test_int_checkbox\": \"checkbox\",\"test_varchar_imagem_upload\": \"imagem-upload\",\"test_tinyint_checkbox\": \"checkbox\"}"
