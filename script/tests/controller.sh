#!/bin/bash
#php ./../../public/index.php gear module delete TestController -v
#php ./../../public/index.php gear module create TestController -v
...
php ../../public/index.php gear controller delete Admin --name="MySecondController" --invokable="%s\Controller\Teste"
