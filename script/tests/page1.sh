...
php ./../../public/index.php gear page create Admin --controllerPage=NameOneController --actionPage=MergeAction --routePage=merge-action --rolePage=guest --invokablePage="%s\Controller\My"
php ./../../public/index.php gear page create Admin --controllerPage=NameOneController --actionPage=TwoMergeAction --routePage=two-merge-action --rolePage=guest --invokablePage="%s\Controller\My"
