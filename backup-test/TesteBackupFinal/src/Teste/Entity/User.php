 ...
 * User
 *
 * @ORM\Table(name="user", uniqueConstraints={@ORM\UniqueConstraint(name="email_UNIQUE", columns={"email"})}, indexes={@ORM\Index(name="created_by", columns={"created_by"}), @ORM\Index(name="updated_by", columns={"updated_by"})})
 * @ORM\Entity
 */
class User
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Teste\Entity\Role", inversedBy="idUser")
     ...
     * Add idRole
     *
     * @param \Teste\Entity\Role $idRole
     * @return User
     */
    public function addIdRole(\Teste\Entity\Role $idRole)
    {
     ...
     * @param \Teste\Entity\Role $idRole
     */
    public function removeIdRole(\Teste\Entity\Role $idRole)
    {
