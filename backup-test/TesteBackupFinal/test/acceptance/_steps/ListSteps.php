...
class ListSteps extends \AcceptanceTester
{

    /**
     * Função responsável por contar quantos ítens possui na cabeça da tabela, pra evitar que apareçam dados a mais que necessário.
     */
