...
cd $modulepath && php public/index.php gear module diagnostic $module $base --type=cli --just=composer
cd $modulepath && php public/index.php gear module diagnostic $module $base --type=cli --just=npm
cd $modulepath && php public/index.php gear module diagnostic $module $base --type=cli --just=file
cd $modulepath && php public/index.php gear module diagnostic $module $base --type=cli --just=dir
cd $modulepath && php public/index.php gear module diagnostic $module $base --type=cli --just=ant
...
cd $modulepath && php public/index.php gear module diagnostic $module $base --type=cli --just=dir
cd $modulepath && php public/index.php gear module diagnostic $module $base --type=cli --just=ant
cd $modulepath && php public/index.php gear module upgrade $module $base --type=cli --just=composer --force
cd $modulepath && php public/index.php gear module upgrade $module $base --type=cli --just=npm --force
cd $modulepath && php public/index.php gear module upgrade $module $base --type=cli --just=file --force
cd $modulepath && php public/index.php gear module upgrade $module $base --type=cli --just=dir --force
cd $modulepath && php public/index.php gear module upgrade $module $base --type=cli --just=ant --force
