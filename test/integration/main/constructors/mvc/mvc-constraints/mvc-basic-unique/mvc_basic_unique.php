...
class MvcBasicUnique extends AbstractMigration
{
    const TABLES = [
        'mvc_basic_unique' => [
            ...
            ***REMOVED***,
            'columns' => [
                'clm_time_basic_unique' => [
                    'type' => 'time'
                ***REMOVED***,
                'clm_datetime_basic_unique' => [
                    'type' => 'datetime'
                ***REMOVED***,
                'clm_date_basic_unique' => [
                    'type' => 'date'
                ***REMOVED***,
                'clm_varchar_basic_unique' => [
                    'type' => 'string'
                ***REMOVED***,
                'clm_text_basic_unique' => [
                    'type' => 'text'
                ***REMOVED***,
                'clm_decimal_basic_unique' => [
                    'type' => 'decimal'
                ***REMOVED***,
                'clm_boolean_basic_unique' => [
                    'type' => 'boolean'
                ***REMOVED***,
                'clm_int_basic_unique' => [
                    'type' => 'integer'
                ***REMOVED***
            ***REMOVED***
        ***REMOVED***
