...
class MvcBasicNullable extends AbstractMigration
{
    const TABLES = [
        'mvc_basic_nullable' => [
            'nullable' => true,
            ...
            ***REMOVED***,
            'columns' => [
                'clm_time_basic_nullable' => [
                    'type' => 'time'
                ***REMOVED***,
                'clm_datetime_basic_nullable' => [
                    'type' => 'datetime'
                ***REMOVED***,
                'clm_date_basic_nullable' => [
                    'type' => 'date'
                ***REMOVED***,
                'clm_varchar_basic_nullable' => [
                    'type' => 'string'
                ***REMOVED***,
                'clm_text_basic_nullable' => [
                    'type' => 'text'
                ***REMOVED***,
                'clm_decimal_basic_nullable' => [
                    'type' => 'decimal'
                ***REMOVED***,
                'clm_boolean_basic_nullable' => [
                    'type' => 'boolean'
                ***REMOVED***,
                'clm_int_basic_nullable' => [
                    'type' => 'integer'
                ***REMOVED***
            ***REMOVED***
        ***REMOVED***
