...
class MvcBasicNullableUnique extends AbstractMigration
{
    const TABLES = [
        'mvc_basic_nullable_unique' => [
            ...
            ***REMOVED***,
            'columns' => [
                'clm_time_nullable_unique' => [
                    'type' => 'time'
                ***REMOVED***,
                'clm_datetime_nullable_unique' => [
                    'type' => 'datetime'
                ***REMOVED***,
                'clm_date_nullable_unique' => [
                    'type' => 'date'
                ***REMOVED***,
                'clm_varchar_nullable_unique' => [
                    'type' => 'string'
                ***REMOVED***,
                'clm_text_nullable_unique' => [
                    'type' => 'text'
                ***REMOVED***,
                'clm_decimal_nullable_unique' => [
                    'type' => 'decimal'
                ***REMOVED***,
                'clm_boolean_nullable_unique' => [
                    'type' => 'boolean'
                ***REMOVED***,
                'clm_int_nullable_unique' => [
                    'type' => 'integer'
                ***REMOVED***
            ***REMOVED***
        ***REMOVED***
