...
class MvcBasicNullableUnique extends AbstractMigration
{
    const TABLES = [
        'mvc_basic_nullable_unique' => [
            ...
            ***REMOVED***,
            'columns' => [
                'clm_time_bsc_nul_uni' => [
                    'type' => 'time'
                ***REMOVED***,
                'clm_datetime_bsc_nul_uni' => [
                    'type' => 'datetime'
                ***REMOVED***,
                'clm_date_bsc_nul_uni' => [
                    'type' => 'date'
                ***REMOVED***,
                'clm_varchar_bsc_nul_uni' => [
                    'type' => 'string'
                ***REMOVED***,
                'clm_text_bsc_nul_uni' => [
                    'type' => 'text'
                ***REMOVED***,
                'clm_decimal_bsc_nul_uni' => [
                    'type' => 'decimal'
                ***REMOVED***,
                'clm_boolean_bsc_nul_uni' => [
                    'type' => 'boolean'
                ***REMOVED***,
                'clm_int_bsc_nul_uni' => [
                    'type' => 'integer'
