...
class MvcConstraintsBasicNullableUnique extends AbstractMigration
{
    const TABLES = [
        'mvc_basic_nullable_unique' => [
            ...
            ***REMOVED***,
            'columns' => [
                'column_time_bsc_nul_uni' => [
                    'type' => 'time'
                ***REMOVED***,
                'column_datetime_bsc_nul_uni' => [
                    'type' => 'datetime'
                ***REMOVED***,
                'column_date_bsc_nul_uni' => [
                    'type' => 'date'
                ***REMOVED***,
                'column_varchar_bsc_nul_uni' => [
                    'type' => 'string'
                ***REMOVED***,
                'column_text_bsc_nul_uni' => [
                    'type' => 'text'
                ***REMOVED***,
                'column_decimal_bsc_nul_uni' => [
                    'type' => 'decimal'
                ***REMOVED***,
                'column_boolean_bsc_nul_uni' => [
                    'type' => 'boolean'
                ***REMOVED***,
                'column_int_bsc_nul_uni' => [
                    'type' => 'integer'
                ***REMOVED***
            ***REMOVED***
        ***REMOVED***
