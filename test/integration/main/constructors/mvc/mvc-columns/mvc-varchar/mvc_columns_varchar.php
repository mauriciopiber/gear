            ...
            ***REMOVED***,
            'columns' => [
                'column_varchar_vrc' => [
                    'type' => 'string'
                ***REMOVED***,
                'column_varchar_password_verify_vrc' => [
                    'type' => 'string',
                    'unique' => false
                ***REMOVED***,
                'column_varchar_upload_image_vrc' => [
                    'type' => 'string',
                    'unique' => false
                ***REMOVED***,
                'column_varchar_url_vrc' => [
                    'type' => 'string'
                ***REMOVED***,
                'column_varchar_unique_id_vrc' => [
                    'type' => 'string',
                    'unique' => false
                ***REMOVED***,
                'column_varchar_telephone_vrc' => [
                    'type' => 'string'
                ***REMOVED***,
                'column_varchar_email_vrc' => [
                    'type' => 'string'
                ***REMOVED***
            ***REMOVED***
        ***REMOVED***
