...
class MvcColumnsVarchar extends AbstractMigration
{
    const TABLES = [
        'mvc_varchar' => [
            'nullable' => false,
            ...
            ***REMOVED***,
            'columns' => [
                'column_varchar_varchar' => [
                    'type' => 'string'
                ***REMOVED***,
                'column_varchar_password_verify_varchar' => [
                    'type' => 'string',
                    'unique' => false
                ***REMOVED***,
                'column_varchar_upload_image_varchar' => [
                    'type' => 'string',
                    'unique' => false
                ***REMOVED***,
                'column_varchar_url_varchar' => [
                    'type' => 'string'
                ***REMOVED***,
                'column_varchar_unique_id_varchar' => [
                    'type' => 'string',
                    'unique' => false
                ***REMOVED***,
                'column_varchar_telephone_varchar' => [
                    'type' => 'string'
                ***REMOVED***,
                'column_varchar_email_varchar' => [
                    'type' => 'string'
                ***REMOVED***
            ***REMOVED***
        ***REMOVED***
