...
class ColumnsCreateCest extends \Column\Acceptance\AbstractCest
{
    public function createSuccessful(AcceptanceTester $I)
    {
        ...
        $I->executeJS(
            sprintf('$("%s").val(\'%s\');', \Column\Pages\ColumnsEditPage::$columnDate, '2016-01-01')
        );
        $I->executeJS(
            sprintf('$("%s").val(\'%s\');', \Column\Pages\ColumnsEditPage::$columnDatetime, '2016-01-01 01:01:01')
        );
        $I->executeJS(
            sprintf('$("%s").val(\'%s\');', \Column\Pages\ColumnsEditPage::$columnTime, '01:01:01')
        );
        ...
        $I->executeJS(
            sprintf('$("%s").val(\'%s\');', \Column\Pages\ColumnsEditPage::$columnDatetimePtBr, '01/01/2016 01:01:01')
        );
        $I->executeJS(
            sprintf('$("%s").val(\'%s\');', \Column\Pages\ColumnsEditPage::$columnDatePtBr, '01/01/2016')
        );
        ...
        $I->seeInField(\Column\Pages\ColumnsEditPage::$columnDate, '2016-01-01');
        $I->seeInField(\Column\Pages\ColumnsEditPage::$columnDatetime, '2016-01-01 01:01:01');
        $I->seeInField(\Column\Pages\ColumnsEditPage::$columnTime, '01:01:01');
        $I->seeInField(\Column\Pages\ColumnsEditPage::$columnInt, '1200');
        $I->seeInField(\Column\Pages\ColumnsEditPage::$columnTinyint, '1');
        $I->seeInField(\Column\Pages\ColumnsEditPage::$columnDecimal, '1200.12');
        ...
        $I->seeInField(\Column\Pages\ColumnsEditPage::$columnDatetimePtBr, '01/01/2016 01:01:01');
        $I->seeInField(\Column\Pages\ColumnsEditPage::$columnDatePtBr, '01/01/2016');
        $I->seeInField(\Column\Pages\ColumnsEditPage::$columnDecimalPtBr, '1200.12');
