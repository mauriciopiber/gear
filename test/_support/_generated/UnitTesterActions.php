<?php  //[STAMP***REMOVED*** 0ec6d7d2cc72b91d2126d5be3ffd3deb
namespace Gear\_generated;
...
trait UnitTesterActions
{
     ...
     * ``` php
     * <?php
     * $I->seeNumRecords(1, 'users', ['name' => 'davert'***REMOVED***)
     * ?>
     * ```
     *
     * @param int    $expectedNumber      Expected number
     * @param string $table    Table name
     * @param array  $criteria Search criteria [Optional***REMOVED***
     * Conditional Assertion: Test won't be stopped on fail
