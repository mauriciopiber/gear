<?php  //[STAMP***REMOVED*** d221533c3e4e5019ad5e24d83b19f833
...
trait AcceptanceTesterActions
{
     ...
     * If Codeception commands are not enough, use [Guzzle HTTP Client***REMOVED***(http://guzzlephp.org/) methods directly
     *
     * Example:
     *
     * ``` php
     ...
     *      $client->get('/get', ['query' => ['foo' => 'bar'***REMOVED******REMOVED***);
     * });
     * ?>
     * ```
     *
     ...
     * ``` php
     * <?php
     * $I->seeInFormFields('form[name=myform***REMOVED***', [
     *      'input1' => 'value',
     *      'input2' => 'other value',
     * ***REMOVED***);
     * ?>
     ...
     *      // ...
     * ***REMOVED***;
     * $I->submitForm('//form[@id=my-form***REMOVED***', $form, 'submitButton');
     * // $I->amOnPage('/path/to/form-page') may be needed
     * $I->seeInFormFields('//form[@id=my-form***REMOVED***', $form);
     * ?>
     * ```
     * 
     * @param $formSelector
     ...
     * ``` php
     * <?php
     * $I->dontSeeInFormFields('form[name=myform***REMOVED***', [
     ...
     * <form action="/sign_up">
     *     Login:
     *     <input type="text" name="user[login***REMOVED***" /><br/>
     *     Password:
     *     <input type="password" name="user[password***REMOVED***" /><br/>
     *     Do you agree to our terms?
     *     <input type="checkbox" name="user[agree***REMOVED***" /><br/>
     *     Select pricing plan:
     *     <select name="plan">
     ...
     * 
     * Field names ending in "[***REMOVED***" must be passed without the trailing square 
     ...
     * $I->submitForm('#my-form', [
     *     'field[***REMOVED***' => 'value',
     *     'field[***REMOVED***' => 'another value', // 'field[***REMOVED***' is already a defined key
     * ***REMOVED***);
     * ```
     * 
