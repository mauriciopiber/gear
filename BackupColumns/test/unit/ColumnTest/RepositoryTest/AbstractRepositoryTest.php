 ...
 * @group Repository
 */
class AbstractRepositoryTest extends \ColumnTest\AbstractTest
{

    protected $pais;
    /**
     * @cover Column\Repository\AbstractRepository::getHydratorObject
     */
    public function testGetSecurityHydrator()
    {
        $abstractRepository = $this->getMockAbstractClass('Column\Repository\AbstractRepository');
    ...
    {
        $abstractRepository = $this->getMockAbstractClass('Column\Repository\AbstractRepository', array(
            'getSelect',
            'getRepositoryName',
            'setUpJoin',
            'getAliase',
    ...
    {
        $abstractRepository = $this->getMockAbstractClass('Column\Repository\AbstractRepository', array('extract'));
        $abstractRepository->setEntityManager($this->bootstrap->getEntityManager());
