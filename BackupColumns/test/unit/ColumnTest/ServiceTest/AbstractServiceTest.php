<?php
namespace Column\ColumnTest\RepositoryTest;

/**
 * @SuppressWarnings(PHPMD.TooManyMethods)
 * @group Service
 */
class AbstractServiceTest extends \ColumnTest\AbstractTest
{
    protected $user;
    ...
    {
        $abstractService = $this->getMockBuilder('Column\Service\AbstractService')
        ->disableOriginalConstructor()
        ->setMethods(array('getRouteMatch'))
        ->getMockForAbstractClass();

        $routeMatch = new \Zend\Mvc\Router\Http\RouteMatch(array(
            'controller' => 'Column\Controller\User',
            'action'     => 'list',
            'page'       => 1,
            'orderBy'    => 'idUser',
            'order'      => 'asc'
