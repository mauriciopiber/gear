 ...
 */
class ForeignKeysListPage extends LayoutPage
{
    public static $URL = '/column/foreign-keys/listar';
    ...
    public static $table = '#foreignKeysTable';

    public static $tableHeadRow = '#foreignKeysTable > thead > tr > th';

    public static $tableBodyRow = '#foreignKeysTable > tbody > tr';

    public static $tableBodyRowColumn = '#foreignKeysTable > tbody > tr:nth-child(%d) td';
