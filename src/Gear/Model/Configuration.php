...
class Configuration
{
    ...
    public function __construct($project, $path, $module, $tables = null, $prefix = null, $speciality = null, $driver = null, $entityManager = null)
    {
        // die('1');
        $makeGear = new \Gear\Model\MakeGear();
        $this->project = $makeGear->str('url', $project);
        $this->path = $path;
