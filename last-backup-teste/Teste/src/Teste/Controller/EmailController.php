...
class EmailController extends AbstractActionController
{
    ...
    const IMAGE  = 'teste/email/image';

    /** @var $emailFactory Teste\Factory\Email */
    protected $emailFactory;

    /** @var $emailService Teste\Service\Email */
    ...
    public function getEmailFactory()
    {
        if (!isset($this->emailFactory)) {
            $this->emailFactory =
                $this->getServiceLocator()->get('Teste\Factory\EmailFactory');
        }
    ...
    public function getEmailService()
    {
        if (!isset($this->emailService)) {
            $this->emailService =
                $this->getServiceLocator()->get('Teste\Service\EmailService');
        }
